module.exports = {
    ...
    'check window fully with fixed scroll root element': {skip: true},			//diffs
    ...
    'acme login with vg': {skip: true},
    'should send dom and location when check frame fully with vg': {skip: true},
    'should send dom and location when check frame fully': {skip: true},
    'should send dom and location when check frame': {skip: true},
    'should send dom and location when check region by selector fully with custom scroll root': {skip: true},
    'should send dom and location when check region by selector fully with vg': {skip: true},
    'should send dom and location when check region by selector fully': {skip: true},
    'should send dom and location when check region by selector in frame with vg': {skip: true},
    'should send dom and location when check region by selector in frame': {skip: true},
    'should send dom and location when check region by selector with custom scroll root with vg': {skip: true},
    'should send dom and location when check region by selector with custom scroll root': {skip: true},
    'should send dom and location when check region by selector with vg': {skip: true},
    'should send dom and location when check region by selector': {skip: true},
    'should send dom and location when check window fully with vg': {skip: true},
    'should send dom and location when check window fully': {skip: true},
    'should send dom and location when check window with vg': {skip: true},
    'should send dom and location when check window': {skip: true},
