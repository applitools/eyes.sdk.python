...
def sel_config(test_page_url):
    ...
    conf.add_browser(700, 500, BrowserType.CHROME_ONE_VERSION_BACK)
    conf.add_browser(700, 500, BrowserType.CHROME_TWO_VERSION_BACK)
    conf.add_browser(700, 500, BrowserType.FIREFOX_ONE_VERSION_BACK)
    conf.add_browser(700, 500, BrowserType.FIREFOX_TWO_VERSION_BACK)
    conf.add_browser(700, 500, BrowserType.SAFARI)
    conf.add_browser(700, 500, BrowserType.SAFARI_ONE_VERSION_BACK)
    conf.add_browser(700, 500, BrowserType.SAFARI_TWO_VERSION_BACK)
