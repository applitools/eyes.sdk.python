...
def test_shadow(target_path_keyword, css_selector, by_selector, web_element):
    res = TargetPath().shadow(by_selector)
...
def test_shadow_region(target_path_keyword, css_selector, by_selector, web_element):
    res = TargetPath().shadow(by_selector).region(web_element)
